...
inline void ClientToBrokerMessage::set_messagetype(::sms::protocol::protobuf::ClientToBrokerMessage_ClientToBrokerMessageType value) {
  GOOGLE_DCHECK(::sms::protocol::protobuf::ClientToBrokerMessage_ClientToBrokerMessageType_IsValid(value));
  set_has_messagetype();
  messagetype_ = value;
}
...
inline void BrokerToClientMessage::set_messagetype(::sms::protocol::protobuf::BrokerToClientMessage_BrokerToClientMessageType value) {
  GOOGLE_DCHECK(::sms::protocol::protobuf::BrokerToClientMessage_BrokerToClientMessageType_IsValid(value));
  set_has_messagetype();
  messagetype_ = value;
}
